...
class _WithdrawalService implements WithdrawalService {
  ...
  Future<HttpResponse<List<WithdrawalModel>>> getWithdrawals({
    ...
    final _options =
        _setStreamType<HttpResponse<List<WithdrawalModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/findallif/withdrawalsbycustomerid/customerid',
    ...
    late List<WithdrawalModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              WithdrawalModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
