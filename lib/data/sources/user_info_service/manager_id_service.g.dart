...
part of 'manager_id_service.dart';
...
class _ManagerIdService implements ManagerIdService {
  _ManagerIdService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<HttpResponse<ResponseModel>> getManagerId({String? customerId}) async {
