...
class _UserInfoService implements UserInfoService {
  _UserInfoService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<HttpResponse<UserInfoModel>> getUserInfo({String? userId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'customerId': userId};
