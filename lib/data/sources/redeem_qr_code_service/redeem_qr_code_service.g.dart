...
part of 'redeem_qr_code_service.dart';
...
class _RedeemQrCodeService implements RedeemQrCodeService {
  _RedeemQrCodeService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
  ...
  Future<HttpResponse<ResponseModel>> redeemQRCode(
      QrCodeReturnModel giftsModel) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(giftsModel.toJson());
